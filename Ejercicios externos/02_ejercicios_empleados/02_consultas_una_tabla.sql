...
SELECT nombre, substring(nif,1,8) AS nif_numeros, substring(nif,9,9) AS nif_letras FROM empleado;
...
SELECT nombre, (presupuesto - gastos) AS presupuesto_actual FROM departamento ORDER BY nombre ASC; 
...
SELECT * FROM empleado WHERE apellido1 IS NOT NULL AND apellido2 IS NOT NULL;
